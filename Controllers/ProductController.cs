...
public class ProductController : ControllerBase
{
    ...
    // IWebhostEnvironment เป็นอินเทอร์เฟซใน ASP.NET Core
    // ที่ใช้สำหรับดึงข้อมูลเกี่ยวกับสภาพแวดล้อมการโฮสต์เวปแอป
    // ContentRootPath: เส้นทางไปยังโฟลเดอร์รากของเวปแอป
    // WebRootPath: เส้นทางไปยังโฟลเดอร์ wwwroot ของเวปแอป
    ...
    public async Task<ActionResult<product>> CreateProduct ([FromForm] product product, IFormFile image)
    {
        ...
        // ตรวจสอบว่ามีการอัพโหลดไฟล์รูปภาพรูปไม่
        if (image != null){
            // กำหนดชื่อไฟล์รูปใหม่ให้ไม่ซ้ำกัน
